  ...
  return (
    ...
    <ScrollView style={styles.container}>
        <View style={styles.container1}>
            <Text style={styles.title1}>Plant Journal</Text>
            
        </View>
      <View>
      <TouchableOpacity style={styles.touchableOpacity} >
            <Image
            style={styles.floationButton}
            source = {{uri:'https://www.clipartmax.com/png/middle/43-433845_ambox-emblem-plus-green-plus-symbol.png'}} /> 
            onPress={NewEntry}
            </TouchableOpacity>
        <View>
